...
public class MealTestData {
    ...
    public static List<Meal> getNotValid() {
        Meal notValidDatetime = getNew();
        notValidDatetime.setDateTime(null);

        Meal notValidDescription = getNew();
        notValidDescription.setDescription("");

        Meal notValidCalories = getNew();
        notValidCalories.setCalories(5001);

        return List.of(notValidDatetime,
                notValidDescription,
                notValidCalories);
    }
}
